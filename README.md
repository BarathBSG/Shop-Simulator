This program simulates a function of a shop on the command-line, using data about customers and transactions from an example day contained in text files.
